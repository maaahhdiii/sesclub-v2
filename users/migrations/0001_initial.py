...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Privelege',
            fields=[
                ('privelege_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privileges', models.ManyToManyField(blank=True, related_name='roles', to='users.privelege')),
            ],
            options={
                'verbose_name': 'Role',
